...
- IRC: [#monero-dev on Libera.chat](https://libera.chat/)
...
Our researchers are available on IRC in [#monero-research-lab on Libera.chat](https://libera.chat/) or by email:
